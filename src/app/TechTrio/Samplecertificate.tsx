...
// import TechImage from '@/app/Home/assets/TechTrioC++.png';
...
//                         <p className=" text-sm lg:text-md">Earn 3 course completion certificates and 1 internship certificate.
//                         </p>
//                     </div>

//                     <div className="flex items-start gap-4">
//                         <div className="text-blue-500">▶</div>
//                         <p className=" text-sm lg:text-md">Prepare for certifications like HackerRank and LeetCode.
//                         </p>
//                     </div>

//                     <div className="flex items-start gap-4">
//                         <div className="text-blue-500">▶</div>
//                         <p className=" text-sm lg:text-md">Gain hands-on experience through project-based learning.
//                         </p>
//                     </div>

//                     <div className="flex items-start gap-4">
//                         <div className="text-blue-500">▶</div>
//                         <p className=" text-sm lg:text-md">Complete 6 mini projects and 3 capstone projects for your portfolio.</p>
//                     </div>
//                 </div>
//             </div>
